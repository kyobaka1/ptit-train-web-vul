...
<aside class="sidebar">
    <div class="r-form">
        ...
        <form class="login" action="" method="get">
            <input type="hidden" name="page" value="sqli_tancong_coban" />
    ...
    <div class="r-form">
        ...
        <?php if(isset($row)){
            echo ' <div class="r-form"><h5>Kết quả: </h5>';
            echo '<div class="r-content"><p><b>Tên sản phẩm:</b> '.$row['tensanpham'].'</p>';
            echo '<p><b>Giá:</b> '.$row['gia'].'</p>';
            echo '<p><b>Người Bán:</b> '.$row['nguoiban'].'</p></div></div>';
        } ?>
</aside>